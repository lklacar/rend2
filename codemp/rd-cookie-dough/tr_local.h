...
#define GLS_SRCBLEND_DST_COLOR					0x00000003ULL
#define GLS_SRCBLEND_ONE_MINUS_DST_COLOR		0x00000004ULL
#define GLS_SRCBLEND_SRC_ALPHA					0x00000005ULL
#define GLS_SRCBLEND_ONE_MINUS_SRC_ALPHA		0x00000006ULL
#define GLS_SRCBLEND_DST_ALPHA					0x00000007ULL
#define GLS_SRCBLEND_ONE_MINUS_DST_ALPHA		0x00000008ULL
#define GLS_SRCBLEND_ALPHA_SATURATE				0x00000009ULL
#define	GLS_SRCBLEND_BITS						0x0000000fULL

#define GLS_DSTBLEND_ZERO						0x00000010ULL
#define GLS_DSTBLEND_ONE						0x00000020ULL
#define GLS_DSTBLEND_SRC_COLOR					0x00000030ULL
#define GLS_DSTBLEND_ONE_MINUS_SRC_COLOR		0x00000040ULL
#define GLS_DSTBLEND_SRC_ALPHA					0x00000050ULL
#define GLS_DSTBLEND_ONE_MINUS_SRC_ALPHA		0x00000060ULL
#define GLS_DSTBLEND_DST_ALPHA					0x00000070ULL
#define GLS_DSTBLEND_ONE_MINUS_DST_ALPHA		0x00000080ULL
#define	GLS_DSTBLEND_BITS						0x000000f0ULL

#define GLS_DEPTHMASK_TRUE						0x00000100ULL

#define GLS_POLYMODE_LINE						0x00001000ULL

#define GLS_DEPTHTEST_DISABLE					0x00010000ULL
#define GLS_DEPTHFUNC_EQUAL						0x00020000ULL

#define GLS_CULL_FRONT							0x00100000ULL
#define GLS_CULL_BACK							0x00200000ULL
