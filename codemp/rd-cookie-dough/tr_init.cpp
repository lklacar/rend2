...
static void GLimp_InitExtensions(void)
{
	...
	{
		qglGetFloatv( GL_MAX_TEXTURE_MAX_ANISOTROPY, &glConfig.maxTextureFilterAnisotropy );
		Com_Printf ("...GL_ARB_texture_filter_anisotropic available\n" );
		...
		{
			Com_Printf ("...ignoring GL_ARB_texture_filter_anisotropic\n" );
		}
	...
	{
		Com_Printf ("...GL_ARB_texture_filter_anisotropic not found\n" );
